...
Descarga un CSV desde un bucket de GCP a RAW_FILE_PATH.
Separa el CSV en train y test con la proporción configurada.
Registra cada paso en el log.

Dentro de cada paso (métodos) se captura Exception para atrapar cualquier error “crudo” del sistema o librerías y se convierte en CustomException. Así, todos los errores salen con un formato uniforme que incluye archivo y línea.
'''
...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.error("Error occurred while downloading CSV from GCP")
