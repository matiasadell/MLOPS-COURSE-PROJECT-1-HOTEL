...
logger = get_logger(__name__) # __name__ toma el nombre del archivo actual
...
class DataPreprocessor:
    ...
    def save_data(self, df, file_path):
        try:
            logger.info(f"Saving processed data in processed folder")
    ...
    def process(self):
        try:
            logger.info("Data Preprocessing pipeline from RAW directory")
